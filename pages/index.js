      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
            ...
            <ul className="flex items-center">
              ...
              <li>
                <a
                  ...
                  href="https://drive.google.com/file/d/148QpsYjpgrPbtydaYqhyfw_JTo2aX7_B/view?usp=drivesdk "
                >
                  Resume / CV
                </a>
              </li>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              I offer from a wide range of services, programming and teaching.
            </p>
          </div>
